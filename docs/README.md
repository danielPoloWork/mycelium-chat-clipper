...
The durable, versioned documentation for `mycelium-chat-clipper`. Everything in `docs/` is a
...
| `docs/i18n/` | Translated documentation (derived copies of the English sources) + the translation-status manifest. |
...
3. [`specs/01_spec_chatclipper.md`](specs/01_spec_chatclipper.md) — what we are building.
