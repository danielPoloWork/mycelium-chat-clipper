...
The mechanical step-by-step for cutting a release of `mycelium-chat-clipper`. The governance
...
pre-1.0 milestone-driven — a +0.1 minor bump per completed milestone from v0.1.0 at M1 (M2 -> v0.2.0, ... M11 -> v0.11.0); v1.0.0 only after every milestone and open issue is fixed (M12).
